...
indicators_US.narm$Time.Period.Start.Date <- as.Date(as.POSIXct(indicators_US.narm$Time.Period.Start.Date, format = "%m/%d/%Y %I:%M:%S %p"))
indicators_US.narm$Time.Period.End.Date <- as.Date(as.POSIXct(indicators_US.narm$Time.Period.End.Date, format = "%m/%d/%Y %I:%M:%S %p"))
```
