...
# Background
Recent findings on the impacts of COVID-19 on mental well-being motivate our analysis. On a global scale, researchers have analyzed data from Google Trends to test whether COVID-19 and the associated lockdowns implemented in Europe and America led to changes in well-being related topic search terms; the detection of a significant increase in searches for loneliness, worry, and sadness suggests that people's mental health may have been severely affected by the pandemic and lockdown [(Brodeur et al., 2020, p. 1)](https://doi.org/10.1016/j.jpubeco.2020.104346). Since data from before the pandemic and lockdowns began is necessary to fully assess how the COVID-19 affects population well-being, Brodeur et al. analyzed data from Google Trends between January 1st 2019 and April 10th 2020 in countries that had introduced a full lockdown by the end of this period [(Brodeur et al., 2020, p. 1)](https://doi.org/10.1016/j.jpubeco.2020.104346). Therefore, we can interpret Brodeur et al.’s finding of a significant increase in search terms related to poor mental well-being as being associated with the pandemic and lockdowns, which supports our expectation of a positive relationship between COVID-19 cases and deaths and indicators of anxiety and depression in the United States.

On a national scale, researchers have identified disparities in the degree of negative mental health consequences associated with COVID-19 across age groups and ethnicities. For example, research in the United States, United Kingdom, and Italy consistently shows that younger adults are more vulnerable to increased psychological distress than older adults [(Abbott, 2020, p. 194](https://doi.org/10.1038/d41586-021-00175-z); [Delmastro & Zamariola, 2020, p. 8)](https://doi.org/10.1038/s41598-020-79850-6), and in the United States, job insecurity associated with the pandemic might exacerbate symptoms of poor mental health among young people [(Ganson et al., 2021, p. 55)](https://doi.org/10.1016/j.jadohealth.2020.10.008). In addition, greater frequencies of negative health outcomes among minority ethnicities may stem from being disproportionately affected by COVID-19 containment policies [(Abbott et al., 2021, p. 194)](https://doi.org/10.1038/d41586-021-00175-z) or from expectations regarding future inability to recover lost economic resources in the future [(Bui et al, 2020, p. 262)](https://doi.org/10.1093/geront/gnaa217). Since these findings come from analysis on either large, representative samples or the HPS, we expect to find similar disparities across age or ethnicities when exploring our secondary question of interest.

We filtered and compiled data from the WHO COVID-19 Dashboard and the HPS to produce a data set on new COVID-19 cases and deaths and frequency of indicators of anxiety or depressive disorder in the United States. Variables of interest include… All WHO COVID-19 data represents the date of reporting as opposed to date of symptom onset and counts of new cases and deaths are calculated by subtracting previous cumulative total counts from the current count. All HPS data corresponds to respondents’ frequency of symptoms associated with depressive or anxiety disorder within the past seven days. The HPS was designed to meet the goal of accurate and timely weekly estimates...(sampling mechanism and target population)...Response rate for the HPS were low, so the survey conductors applied a weighting procedure within each state consisting of four adjustments that were applied to the base weights…(key variables)…
...
In the first figure, the racial groups with the lowest survey responses indicating Anxiety or Depression, by almost 10%, are Non-Hispanic white and Non-Hispanic Asian. In the second figure, female respondents indicated anxiety or depression symptoms greater than 10% more male respondents. The third figure shows a heat map of the United States where more yellow coloring represents low percentages of responses indicating anxiety or depression and more blue colors represent higher percentages of responses. It appears the northern-middle part of the country has lowest percentages of responses indicating anxiety or depression, by almost 10%.
...
ggplot(all.df.m, aes(Date,value,colour = variable)) + 
  ...
  labs(title = "Depression or Anxiety Symptoms", 
       subtitle = "Average 2020 Household Pulse Survey",
       y = "Value of respective datasets (in order top to bottom): [Cases] [Deaths] [% trend], [% trend], [% with symptoms]") + 
  theme(text = element_text(size = 8), element_line(size = 0.2))
```

Finally, the following two tables present aggregated statistics for each month from the WHO COVID-19 Data.
...
Strangely, the month of May has a day with a negative number of deaths and the maximum number of deaths in a day is exactly 5,000. The first issue is impossible and the second issue is highly unlikely. Further investigation outside this report is warranted by this strange behavior, but for now the first error is assumed to be a correction of an over-count and the second error is assumed to be an estimate of that day's number of deaths due to COVID. Both of these can be considered a part of the noise that naturally exists in the data. 
...
The analysis was conducted by aggregating the daily case data found in the WHO data set with the anxiety data used from the CDC. Using this, a linear model was created to analyze the relationship between case rates and anxiety rates. It was found that there is a relationship between these two variables with an extremely low p-value with the model assumptions appearing to hold. 

One major factor to keep in mind is that depression has been studied extensively and many factors have been found to be related to depression. Some of these factors include staying indoors extensively, loss of employment, among other things. Many factors of life linked to increased depression can also be related to the rise in COVID-19 cases. For example, the increase in cases resulted in an increase in unemployment as businesses were forced to shut down due to the newest restrictions. Thus, the unemployment rate could be a cofounder that obfuscates the true cause in increase in anxiety rates. Other factors such as an increase in family or friends dying as a result of the pandemic could certainly have a significant impact on overall mental health. It is important to not conclude that COVID-19 cases *cause* increase anxiety rates but we simply showed there was a relationship in this analysis.
